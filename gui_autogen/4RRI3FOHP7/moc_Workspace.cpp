...
QT_MOC_LITERAL(1, 10, 14), // "signalModified"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16) // "slotSceneUpdated"

    },
    "Workspace\0signalModified\0\0slotSceneUpdated"
};
...
void Workspace::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalModified(); break;
        case 1: _t->slotSceneUpdated(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Workspace::signalModified)) {
                *result = 0;
                return;
            }
        }
